                                    ...
                                    <div key={fasilitas.href} className='grid-cols-1 grid-rows-1 bg-[#DFDFDF] rounded-3xl p-5'>
                                        <div className=' flex flex-col gap-5'>
                                            <div className=' flex flex-row gap-3 items-center'>
                                                <img src={fasilitas.icon} alt={fasilitas.name} className=' size-[64px] rounded-2xl object-cover object-center bg-[#B2B2B2] p-1'></img>
                                            ...
                                            <div className='bg-black rounded-full p-2 self-end hover:scale-105 duration-300 cursor-pointer'>
                                                <a href={`/fasilitas/${fasilitas.href}`} aria-label={`Go to ${fasilitas.name}`}><FaArrowRight className=' text-white size-6'/></a>
                                            </div>
                                        </div>
                                    </div>
                                )
